            ...
            <div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block"><a
                ...
                <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a"
                    ...
                    <div class="cz-bg-image row sb-bg-img">
                        <div class="col-sm-2 mb-3"><img src="{{ asset('app-assets/img/sidebar-bg/01.jpg') }}"
                                width="90" class="rounded sb-bg-01">
                        </div>
                        <div class="col-sm-2 mb-3"><img src="{{ asset('app-assets/img/sidebar-bg/02.jpg') }}"
                                width="90" class="rounded sb-bg-02">
                        </div>
                        <div class="col-sm-2 mb-3"><img src="{{ asset('app-assets/img/sidebar-bg/03.jpg') }}"
                                width="90" class="rounded sb-bg-03">
                        </div>
                        <div class="col-sm-2 mb-3"><img src="{{ asset('app-assets/img/sidebar-bg/04.jpg') }}"
                                width="90" class="rounded sb-bg-04">
                        </div>
                        <div class="col-sm-2 mb-3"><img src="{{ asset('app-assets/img/sidebar-bg/05.jpg') }}"
                                width="90" class="rounded sb-bg-05">
                        </div>
                        <div class="col-sm-2 mb-3"><img src="{{ asset('app-assets/img/sidebar-bg/06.jpg') }}"
                                width="90" class="rounded sb-bg-06">
                        </div>
                    </div>
